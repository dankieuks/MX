...
const Completed = () => {
    ...
    return (
        ...
        <span>
            ...
            </span> {checkFirst? <span>Task done</span>:<del> Task done</del>}
            </div>
            <div>
            <span>
            <input type="checkbox" onChange={checkBox2}></input>
            </span>{check2? <span>Task done</span>:<del>Task done</del>}
            </div>
            <div>
            <span>
            <input type="checkbox" onChange={checkBox3}></input>
            </span>{check3? <span>Task done</span>:<del> Task done</del>}
            </div>
            </div>
        </div>
        </div>
